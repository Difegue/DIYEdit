...
public class MetadataFrame extends JFrame implements ActionListener, ItemListener {
	...
	public MetadataFrame(String fname) {
		bbbbbbb = ResourceBundle.getBundle("com.xperia64.diyedit.resources.Resources",
				(Locale.getDefault().getLanguage().equals("zh") || Globals.forceChina) ? Locale.CHINA : Locale.US);
		filz = fname;
	...
	void setupGUI() {
		...
		ZonedDateTime date = ZonedDateTime.of(2000, 1, 1, 0, 0, 0, 0, ZoneId.systemDefault());
		date = date.plusDays(Timestamps);
		Timestamp.setText(date.getMonthValue() + "/" + date.getDayOfMonth() + "/" + date.getYear());
		...
		switch (Globals.MetadataMode) {
			case 0:
				...
				String[] labels_game = { (String) bbbbbbb.getObject("pulseMetadataKey"),
						(String) bbbbbbb.getObject("rocketMetadataKey"),
						(String) bbbbbbb.getObject("shieldMetadataKey"), (String) bbbbbbb.getObject("punchMetadataKey"),
						(String) bbbbbbb.getObject("carMetadataKey"), (String) bbbbbbb.getObject("batMetadataKey"),
				...
				String[] carts = { (String) bbbbbbb.getObject("roundMetadataKey"),
						(String) bbbbbbb.getObject("notchMetadataKey"), (String) bbbbbbb.getObject("flatMetadataKey"),
						(String) bbbbbbb.getObject("ridgesMetadataKey"),
						(String) bbbbbbb.getObject("zigzagMetadataKey"),
						(String) bbbbbbb.getObject("prongsMetadataKey"),
						(String) bbbbbbb.getObject("angledMetadataKey"), (String) bbbbbbb.getObject("gbaMetadataKey"),
			...
			case 1:
				...
				String[] records = { (String) bbbbbbb.getObject("circleMetadataKey"),
						(String) bbbbbbb.getObject("squareMetadataKey"), (String) bbbbbbb.getObject("starMetadataKey"),
						(String) bbbbbbb.getObject("hexagonMetadataKey"),
						(String) bbbbbbb.getObject("cloverMetadataKey"),
						(String) bbbbbbb.getObject("diamondMetadataKey"), (String) bbbbbbb.getObject("plusMetadataKey"),
						(String) bbbbbbb.getObject("flowerMetadataKey") };
				...
				String[] labels_record = { (String) bbbbbbb.getObject("heartMetadataKey"),
						(String) bbbbbbb.getObject("flowerLogoMetadataKey"),
						(String) bbbbbbb.getObject("stormMetadataKey"), (String) bbbbbbb.getObject("crossMetadataKey"),
						(String) bbbbbbb.getObject("leafMetadataKey"), (String) bbbbbbb.getObject("dropletMetadataKey"),
						(String) bbbbbbb.getObject("lightningMetadataKey"),
						(String) bbbbbbb.getObject("smileMetadataKey") };
				Logo.setRenderer(new MyRend(setupImages(4), labels_record));
				getContentPane().add(Logo);
				break;
			case 2:
				String[] labels_manga = { (String) bbbbbbb.getObject("letterMetadataKey"),
						(String) bbbbbbb.getObject("houseMetadataKey"), (String) bbbbbbb.getObject("shieldMetadataKey"),
						(String) bbbbbbb.getObject("skullMetadataKey"), (String) bbbbbbb.getObject("catMetadataKey"),
						(String) bbbbbbb.getObject("batMetadataKey"),
						(String) bbbbbbb.getObject("spaceshipMetadataKey"),
						(String) bbbbbbb.getObject("smileMetadataKey") };
